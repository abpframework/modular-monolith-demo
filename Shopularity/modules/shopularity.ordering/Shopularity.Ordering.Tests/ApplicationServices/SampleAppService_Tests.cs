...
using Shouldly;
using Xunit;
using Shopularity.Ordering.Samples;

namespace Shopularity.Ordering.Tests.ApplicationServices;
...
public class SampleAppService_Tests : OrderingIntegrationTestBase
{
