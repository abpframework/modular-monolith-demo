...
namespace Shopularity.Migrations
{
    ...
    [Migration("20250825103109_Added_TotalPrice_To_Payment")]
    partial class Added_TotalPrice_To_Payment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shopularity.Catalog.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Shopularity.Catalog.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shopularity.Ordering.OrderLines.OrderLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shopularity.Ordering.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shopularity.Payment.Payments.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shopularity.Catalog.Products.Product", b =>
                {
                    b.HasOne("Shopularity.Catalog.Categories.Category", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Shopularity.Ordering.OrderLines.OrderLine", b =>
                {
                    b.HasOne("Shopularity.Ordering.Orders.Order", null)
                        .WithMany("OrderLines")
