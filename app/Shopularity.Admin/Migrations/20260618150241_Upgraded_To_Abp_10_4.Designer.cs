...
{
    [DbContext(typeof(ShopularityDbContext))]
    [Migration("20260618150241_Upgraded_To_Abp_10_4")]
    partial class Upgraded_To_Abp_10_4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shopularity.Catalog.Domain.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Shopularity.Catalog.Domain.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shopularity.Ordering.Domain.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shopularity.Ordering.Domain.Orders.OrderLines.OrderLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shopularity.Payment.Domain.Payments.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PaymentPayments", (string)null);
                });
            ...
            modelBuilder.Entity("Shopularity.Catalog.Domain.Products.Product", b =>
                {
                    b.HasOne("Shopularity.Catalog.Domain.Categories.Category", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Shopularity.Ordering.Domain.Orders.OrderLines.OrderLine", b =>
                {
                    b.HasOne("Shopularity.Ordering.Domain.Orders.Order", null)
                        .WithMany("OrderLines")
