...
namespace Shopularity.Menus;

public class ShopularityMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public ShopularityMenuContributor(IConfiguration configuration)
    {
